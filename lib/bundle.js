...
/***/ function(module, exports) {
	...
	Note.prototype.draw = function(ctx) {
	  ...
	  ctx.fillRect(this.pos[0], this.pos[1], 70, 70); //fillRect(x, y, width, height)
	};
	...
	Note.prototype.checkOverlap = function() {
	  if ((this.game.height < this.pos[1]) && (this.pos[1] < this.game.height + 2)) {
